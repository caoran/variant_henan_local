...
public class CHARGE_LONGTHD extends VariantValueInvoke {
	...
	private void initStr(String dbFile) {
		...
		String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_CS_VOLTEPARAM   t WHERE  t.ne_type='MGCF' AND t.VENDOR_NAME='中兴' AND t.ACT_TBNAME='CHARGE' AND t.param_name='最大通话时长'";
