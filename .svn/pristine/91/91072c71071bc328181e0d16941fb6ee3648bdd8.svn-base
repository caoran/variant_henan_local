...
public class SPEED extends VariantValueInvoke {
    ...
    private void initStr(String dbFile) {
        ...
        String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_CS_VOLTEPARAM  t WHERE  t.ne_type='IMSMGW' AND t.VENDOR_NAME='中兴' AND t.ACT_TBNAME='ENETPORTPARA' AND t.param_name='SPEED'";
