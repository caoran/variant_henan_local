...
public class SCP extends VariantValueInvoke {
    ...
    private void initMap(String dbFile) {
        ...
        String sql = "SELECT DEVICENAME,GROUP_CONCAT(SCPNO) SCPNO  FROM HW_UAP_IPADR WHERE cast(SCPNO as int) BETWEEN 101 AND 65535 GROUP BY DEVICENAME";
