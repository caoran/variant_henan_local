...
public class GxFunctionality extends VariantValueInvoke
{
  ...
  private void initStr(String dbFile) {
    ...
    String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_VOLTEPARAM  t WHERE  t.ne_type='SAEGW' AND t.VENDOR_NAME='诺基亚' AND t.ACT_TBNAME='ng' AND t.param_name='gx-functionality'";
