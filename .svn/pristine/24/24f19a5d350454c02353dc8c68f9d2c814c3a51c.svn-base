 ...
 * note:
 */
package com.boco.soap.variant.henan.local.scp.ppsmsisdntoid.hw;
...
public class startGtBegin extends VariantValueInvoke {
    ...
    private void initMap(String dbFile, String deviceName) {
        ...
        String sql = "SELECT PROVINCE,START_GT FROM  TCM_CMCC_BOSS_GT m WHERE START_GT not IN (SELECT MSISDNSTART FROM  HW_SCP_PPS_MSISDNTOID q WHERE DEVICENAME='"
