...
public class HW_GMSS_CLDPREANA_CSCNAMEZZA extends VariantValueInvoke {
    ...
    private void initCityMap(String dbFile, String sNename) {
        ...
        String sql = "select '" + sNename + "' DEVICENAME,COVER_CITY from TCM_HW_GMSS_MTB_REL where  DEVICENAME='" + sNename + "'";
