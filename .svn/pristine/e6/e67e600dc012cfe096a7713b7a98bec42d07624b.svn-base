 ...
 */
public class Volte_EMSC_NK_ZWQI_CLASS implements ISpliteOperate{
	...
	public List<Map<String, String>> operate(List<Map<String, String>> oldList) {
		...
		for(Map<String,String> map : oldList){
			String num = map.get("PARAMETER_CLASS");
			if(num!=null&&!num.equals("")){
				//TS 
				commNum = num;	
				newList.add(map);
			}else{
				List<Map<String,String>> newCodeList = this.copy(map,commNum,"PARAMETER_CLASS");
