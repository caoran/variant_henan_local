...
public class DEFSESSREFTIM extends VariantValueInvoke {
	...
	private void initStr(String dbFile) {
		...
		String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_CS_VOLTEPARAM   t WHERE  t.ne_type='MGCF' AND t.VENDOR_NAME='中兴' AND t.ACT_TBNAME='SIPSESSTIM' AND t.param_name='默认会话刷新时长'";
