...
public class BELL_HDRA_RTRSLTNAME extends VariantValueInvoke {
	...
	public String[] getValues(INeElement arg0, IInstructionParameter arg1,
		...
		if (_province == null) {
			 ...
			 */
			if (_province.toString().contains("河南")
					|| _province.toString().contains("山西")) {
	...
	private void initMap(String dbFile) {
		...
		for (Map<String, ?> temp : resultList) {
			_draMap.put(temp.get("PROVINCE").toString(), temp.get("RTRSLTNAME")
					.toString());
