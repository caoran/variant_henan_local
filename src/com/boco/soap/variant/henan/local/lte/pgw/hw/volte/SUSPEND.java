...
public class SUSPEND extends VariantValueInvoke {
	...
	private void initStr(String dbFile) {
		...
		String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_VOLTEPARAM   t WHERE  t.ne_type='PGW' AND t.VENDOR_NAME='华为' AND t.ACT_TBNAME='gtp-support' AND t.param_name='支持挂起信息'";
