...
public class N3REQUESTS extends VariantValueInvoke {
	...
	private void initStr(String dbFile) {
		...
		String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_VOLTEPARAM   t WHERE  t.ne_type='PGW' AND t.VENDOR_NAME='爱立信' AND t.ACT_TBNAME='S4s11C' AND t.param_name='n3Requests'";
