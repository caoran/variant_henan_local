...
public class HSIMSVOPS extends VariantValueInvoke {
	...
	private void initStr(String dbFile) {
		...
		String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_VOLTEPARAM   t WHERE  t.ne_type='MME' AND t.VENDOR_NAME='华为'  AND t.param_name='Homogeneous Support of IMS VoPS信元'";
