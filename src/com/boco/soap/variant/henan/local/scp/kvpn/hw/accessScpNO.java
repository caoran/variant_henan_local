 ...
 *
 */
public class accessScpNO extends VariantValueInvoke {
    ...
    public String[] getValues(INeElement arg0, IInstructionParameter arg1, Map<String, ?> data, String dbFile) {
        ...
        if (null == startGt) {
            ...
            accessScpNo = this.getAccessScpNo(startGt.toString().trim(), areaCode.toString().trim(), areaCity, dbFile);
        }

        return new String[] { accessScpNo };
    }
