...
public class NORMALHBTIME extends VariantValueInvoke {
	...
	private void initStr(String dbFile) {
		...
		String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_CS_VOLTEPARAM   t WHERE  t.ne_type='MGCF' AND t.VENDOR_NAME='中兴' AND t.ACT_TBNAME='SIPLNK' AND t.param_name='SIP中继心跳T100定时器'";
