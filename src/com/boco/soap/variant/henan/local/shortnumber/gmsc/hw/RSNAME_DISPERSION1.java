...
/**
 * 短号码 gmsc 路由选择名称（RSNAME_DISPERSION）
 * 
 * @author changquanzhou
 * @Email changquanzhou@boco.com.cn
 * @description 在分散接入时，根据网元归属地市，号首1对应的路由
 */
public class RSNAME_DISPERSION1 extends VariantValueInvoke {
	...
	private String getAreaName(String dbFile, String neName,String area) {
		...
		if (resultList != null && resultList.size() > 0) {
			String cityStr = resultList.get(0).get("CITY2").toString().trim();
			String cityeEngStr = resultList.get(0).get("CITY_ENG2").toString().trim();
