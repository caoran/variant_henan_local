...
public class PORTNO extends VariantValueInvoke {
	...
	public String[] getValues(INeElement arg0, IInstructionParameter arg1,
	 ...
	 private void initStr(String dbFile,String NEName) {
		    ...
		    String sql = "SELECT t.portno FROM zte_volte_mgw_enetportpara t where DEVICENAME='"+NEName+"'";
...
//		    } 
		    int i=0;
			   for(Map<String, ?> temp : resultList){
				   String tmp = (String)temp.get("PORTNO");
				   paramValue[i] = tmp;
				   i++;   
			   } 
		  }
